...
lastHarvestReportApi.openapi(lastHarvestReportsRoute, async c => {
    const query = `
      SELECT 
        ...
        simulation_started, simulation_ok, simulation_ko_reason,
        simulation_last_harvest, simulation_hours_since_last_harvest,
        simulation_is_last_harvest_recent, simulation_paused,
        ...
        decision_started, decision_ok, decision_ko_reason,
