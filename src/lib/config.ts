...
export const HARVEST_OVERESTIMATE_GAS_PRICE_BY_PERCENT = parseFloat(
    process.env.HARVEST_OVERESTIMATE_GAS_PRICE_BY_PERCENT || '0.5'
);
export const HARVEST_LIMIT_GAS_AMOUNT_BY_PERCENT = parseFloat(process.env.HARVEST_LIMIT_GAS_AMOUNT_BY_PERCENT || '0.5');
