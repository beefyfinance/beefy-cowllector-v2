...
import { type AggressivelyWriteContractParameters, type AggressivelyWriteContractReturnType, aggressivelyWriteContract } from './aggressivelyWriteContract';
import { simulateContractInBatch } from './simulateContractInBatch';

type CustomRpcPublicActions<TChain extends ViemChain | undefined = ViemChain | undefined, TAccount extends Account | undefined = Account | undefined> = {
    aggressivelyWaitForTransactionReceipt: (
...
type CustomRpcWalletActions<_TChain extends ViemChain | undefined = ViemChain | undefined> = {
