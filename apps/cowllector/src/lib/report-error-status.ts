 ...
 */
export function getReportAsyncStatus<T>({ chain, vault }: ReportAsyncStatusContext, report: Async<T> | null): ReportAsyncStatus {
    if (report === null) {
        return 'not-started';
    }
...
export function mergeReportAsyncStatus<_A, _B>(statusA: ReportAsyncStatus, statusB: ReportAsyncStatus): ReportAsyncStatus {
...
export function getMergedReportAsyncStatus(ctx: ReportAsyncStatusContext, reports: Array<Async<unknown> | null>): ReportAsyncStatus {
